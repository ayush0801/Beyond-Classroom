            ...
            <Image src={imageURL} alt="Login" />
            {
              account === 'login' ?
                  <Wrapper>
                    ...
                    <TextField onChange={(e) => onValueChange(e)} value={login.password} name='password' label="Password" variant="standard" />
                  ...
                  <Wrapper>
                    ...
                    <TextField onChange={(e) => onInputChange(e)} name='password' label="Password" variant="standard" />
